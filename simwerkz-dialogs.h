...
public:
	...
	const char *get_tooltip(const spieler_t *) const { return translator::translate("Line Management"); }
	virtual image_id get_icon(spieler_t *sp) const { return sp->get_player_nr()==1 ? IMG_LEER : icon; }
	bool is_selected(const karte_t *welt) const { return win_get_magic(magic_line_management_t+welt->get_active_player_nr()); }
...
public:
	...
	const char *get_tooltip(const spieler_t *) const { return translator::translate("Finanzen"); }
	bool is_selected(const karte_t *welt) const { return win_get_magic(magic_finances_t+welt->get_active_player_nr()); }
	bool init( karte_t *, spieler_t *sp ) {
...
public:
	...
	const char *get_tooltip(const spieler_t *) const { return translator::translate("cl_title"); }
	bool is_selected(const karte_t *welt) const{ return win_get_magic(magic_convoi_list+welt->get_active_player_nr()); }
	bool init( karte_t *, spieler_t *sp ) {
