...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_mainhelp); return false; }
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_optionen_gui_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_reliefmap); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t* const sp) OVERRIDE { destroy_win(win_get_magic(magic_line_management_t + sp->get_player_nr())); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_messageframe); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t* const sp) OVERRIDE { destroy_win(magic_finances_t + sp->get_player_nr()); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_ki_kontroll_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_color_gui_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_sound_kontroll_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_sprachengui_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_farbengui_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_jump); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_load_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_save_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_halt_list_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t* const sp) OVERRIDE { destroy_win(magic_convoi_list + sp->get_player_nr()); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_citylist_frame_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_goodslist); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_factorylist); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_curiositylist); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool init(spieler_t* sp) OVERRIDE {
		if (!is_selected()) {
			create_win( new factory_edit_frame_t(sp), w_info, magic_edit_factory );
		}
		return false;
	}
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_edit_factory); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool init(spieler_t* sp) OVERRIDE {
		if (!is_selected()) {
			create_win( new curiosity_edit_frame_t(sp), w_info, magic_edit_attraction );
		}
		return false;
	}
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_edit_attraction); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool init(spieler_t* sp) OVERRIDE {
		if (!is_selected()) {
			create_win( new citybuilding_edit_frame_t(sp), w_info, magic_edit_house );
		}
		return false;
	}
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_edit_house); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool init(spieler_t* sp) OVERRIDE {
		if (baum_t::get_anzahl_besch() > 0  &&  !is_selected()) {
			create_win( new baum_edit_frame_t(sp), w_info, magic_edit_tree );
		}
		return false;
	}
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_edit_tree); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	char const* get_tooltip(spieler_t const*) const OVERRIDE { return env_t::networkmode ? translator::translate("deactivated in online mode") : translator::translate("enlarge map"); }
	image_id get_icon(spieler_t *) const { return env_t::networkmode ? IMG_LEER : icon; }
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_bigger_map); return false; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_labellist); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	char const* get_tooltip(spieler_t const*) const OVERRIDE { return (!env_t::networkmode  ||  env_t::server) ? translator::translate("Climate Control") : translator::translate("deactivated in online mode"); }
	image_id get_icon(spieler_t *) const { return (!env_t::networkmode  ||  env_t::server) ? icon : IMG_LEER; }
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_climate); return false; }
};
...
public:
	...
	char const* get_tooltip(spieler_t const*) const OVERRIDE { return (!env_t::networkmode  ||  env_t::server) ? translator::translate("Setting") : translator::translate("deactivated in online mode"); }
	image_id get_icon(spieler_t *) const { return (!env_t::networkmode  ||  env_t::server) ? icon : IMG_LEER; }
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_settings_frame_t); return false; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_server_frame_t); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
...
public:
	...
	bool exit(spieler_t*) OVERRIDE { destroy_win(magic_themes); return false; }
	bool is_init_network_save() const OVERRIDE { return true; }
	bool is_work_network_save() const OVERRIDE { return true; }
};
#endif
