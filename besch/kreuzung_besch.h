 ...
 *	2   Bild
 */
class kreuzung_desc_t : public obj_desc_timelined_t {
...
public:
	 ...
	 */
	const image_t *get_image(int ns, bool open, int phase) const
	{
		if(open) {
	...
	const image_t *get_image_after(int ns, bool open, int phase) const
	{
