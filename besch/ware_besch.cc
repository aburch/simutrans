 ...
 */
void ware_besch_t::set_scale(uint16 scale_factor)
{
	scaled_values.clear();
	uint16 new_price;
	uint32 new_distance;
 ...
 */
sint64 ware_besch_t::get_base_fare(uint32 distance_meters, uint32 starting_distance) const
{
	sint64 total_fare = 0;
 ...
 */
sint64 ware_besch_t::get_fare_with_speedbonus(sint16 relative_speed_percentage, uint32 distance_meters, uint32 starting_distance) const
{
 ...
 */
sint64 ware_besch_t::get_fare_with_comfort_catering_speedbonus(karte_t* world,
