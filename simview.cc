...
{
	DBG_DEBUG("karte_ansicht_t::display", "starting ...");
	...
	DBG_DEBUG("karte_ansicht_t::display", "display ground");
	int	y;
	...
	DBG_DEBUG("karte_ansicht_t::display", "display things");
	for(y=y_min; y<dpy_height+4*4; y++) {
	...
	DBG_DEBUG("karte_ansicht_t::display", "display overlays");
	for(y=y_min; y<dpy_height+4*4; y++) {
	...
	DBG_DEBUG("karte_ansicht_t::display", "display pointer");
	if(zeiger) {
	...
	DBG_DEBUG("karte_ansicht_t::display", "display ticker");
	if(welt) {
	...
	DBG_DEBUG("karte_ansicht_t::display", "... ready");
}
