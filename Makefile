...
SOURCES += besch/bild_desc.cc
SOURCES += besch/bruecke_desc.cc
SOURCES += besch/fabrik_desc.cc
SOURCES += besch/grund_desc.cc
SOURCES += besch/haus_desc.cc
...
SOURCES += besch/vehikel_desc.cc
SOURCES += besch/ware_desc.cc
SOURCES += besch/weg_desc.cc
