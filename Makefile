...
SOURCES += descriptor/bild_besch.cc
SOURCES += descriptor/bruecke_besch.cc
SOURCES += descriptor/fabrik_besch.cc
SOURCES += descriptor/grund_besch.cc
SOURCES += descriptor/haus_besch.cc
SOURCES += descriptor/obj_besch_std_name.cc
...
SOURCES += descriptor/sound_besch.cc
SOURCES += descriptor/tunnel_besch.cc
SOURCES += descriptor/vehikel_besch.cc
SOURCES += descriptor/ware_besch.cc
SOURCES += descriptor/weg_besch.cc
