...
SOURCES += besch/image.cc
SOURCES += besch/bridge_desc.cc
SOURCES += besch/factory_desc.cc
SOURCES += besch/ground_desc.cc
SOURCES += besch/building_desc.cc
SOURCES += besch/obj_desc_std_name.cc
...
SOURCES += besch/sound_desc.cc
SOURCES += besch/tunnel_desc.cc
SOURCES += besch/vehicle_desc.cc
SOURCES += besch/goods_desc.cc
SOURCES += besch/way_desc.cc
