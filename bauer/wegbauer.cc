		...
		while(iter.next()) {
			...
			if(intro_month == current_month) {
				sprintf(buf,
					...
					welt->get_message()->add_message(buf,koord::invalid,message_t::new_vehicle,NEW_VEHICLE,besch->gib_bild_nr(5,0));
			}
