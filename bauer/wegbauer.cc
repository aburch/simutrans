...
bool wegbauer_t::intern_calc_route_runways(koord3d start3d, const koord3d ziel3d)
{
	...
	if(	 !(welt->is_within_map_limits(start-koord(5,5))  &&  welt->is_within_map_limits(start+koord(5,5)))  ||
		 !(welt->is_within_map_limits(ziel-koord(5,5))  &&  welt->is_within_map_limits(ziel+koord(5,5)))  ) {
