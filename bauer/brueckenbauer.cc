			...
			if(  gr2  ) {
				...
				switch(  max_end_height  ) {
					case 0: {
						...
						else if(  i == max_height - 1 && env_t::pak_height_conversion_factor == 2  &&  ((wegtyp != powerline_wt && gr2->get_weg_nr(0) && gr2->get_weg_nr(0)->get_besch()->get_topspeed()>0)  ||  gr2->get_leitung())  ) {
