...
private:
	...
	static bool is_monorail_junction(koord3d pos, player_t *player, const bruecke_desc_t *desc, const char *&error_msg);
public:
	/**
	 ...
	 */
	static koord3d finde_ende(player_t *player, koord3d pos, const koord zv, const bruecke_desc_t *desc, const char *&error_msg, sint8 &bridge_height, bool ai_bridge=false, uint32 min_length=0, bool high_bridge = false );
	 ...
	 */
	static void baue_auffahrt(player_t *player, koord3d end, ribi_t::ribi ribi_neu, slope_t::type weg_hang, const bruecke_desc_t *desc, const weg_desc_t *weg_desc);
	 ...
	 */
	static void baue_bruecke(player_t *player, const koord3d start, const koord3d end, koord zv, sint8 bridge_height, const bruecke_desc_t *desc, const weg_desc_t *weg_desc);
	 ...
	 */
	static void register_desc(bruecke_desc_t *desc);


	static bool laden_erfolgreich();

	static stringhashtable_tpl<bruecke_desc_t *> * get_all_bridges();
	 ...
	 */
	static const bruecke_desc_t *get_desc(const char *name);
	 ...
	 */
	static const char *baue( player_t *player, koord3d pos, const bruecke_desc_t *desc);
	 ...
	 */
	static const bruecke_desc_t *find_bridge(const waytype_t wtyp, const sint32 min_speed,const uint16 time, const uint16 max_weight = 2);
