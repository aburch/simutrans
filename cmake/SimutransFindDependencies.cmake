...
if (NOT ANDROID)
	...
	set(SHARED_LIBRARY_SO ${CMAKE_CURRENT_SOURCE_DIR}/../bzip2/prebuilt/debug/${CMAKE_ANDROID_ARCH_ABI}/libbz2.so)
	...
	if (CMAKE_BUILD_TYPE STREQUAL "Debug")
		set(SHARED_LIBRARY_SO ${CMAKE_CURRENT_SOURCE_DIR}/../libpng/prebuilt/debug/${CMAKE_ANDROID_ARCH_ABI}/libpng16d.so)
	else ()
		set(SHARED_LIBRARY_SO ${CMAKE_CURRENT_SOURCE_DIR}/../libpng/prebuilt/debug/${CMAKE_ANDROID_ARCH_ABI}/libpng16.so)
	endif ()
	...
	set(SHARED_LIBRARY_SO ${CMAKE_CURRENT_SOURCE_DIR}/../zstd/prebuilt/debug/${CMAKE_ANDROID_ARCH_ABI}/libzstd.so)
	...
	if (CMAKE_BUILD_TYPE STREQUAL "Debug")
		set(SHARED_LIBRARY_SO ${CMAKE_CURRENT_SOURCE_DIR}/../freetype/prebuilt/debug/${CMAKE_ANDROID_ARCH_ABI}/libfreetyped.so)
	else ()
		set(SHARED_LIBRARY_SO ${CMAKE_CURRENT_SOURCE_DIR}/../freetype/prebuilt/debug/${CMAKE_ANDROID_ARCH_ABI}/libfreetype.so)
	endif ()
