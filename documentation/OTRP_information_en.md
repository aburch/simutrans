...
As of version 24, OTRP is based on simutrans standard nightly r8943.
...
You can download the OTRP executable binary from the links below. **(2020 March 3rd, updated to ver 24.)**  
windows（GDI）: https://osdn.net/projects/otrp/downloads/72470/sim-WinGDI-OTRPv24.exe/  
mac: https://osdn.net/projects/otrp/downloads/72470/sim-mac-OTRPv24.zip/    
Linux: https://osdn.net/projects/otrp/downloads/72470/sim-linux-OTRPv24.zip/  
...
- Replacement seed button in the depot window designates the convoy as the replacement seed. When the replacement seed is set, cars of convoys that arrive at the depot are replaced with cars of the replacement seed.
