...
BEGIN {
	...
	export_types["::calc_max_speed"] = "integer(integer, integer, integer)"
	export_types["::speed_to_tiles_per_month"] = "integer(integer)"
	...
	export_types["::get_available_vehicles"] = "array<vehicle_desc_x>(way_types)"
	...
	export_types["::is_coupling_allowed"] = "bool(vehicle_desc_x, vehicle_desc_x)"
	...
	export_types["::get_available_stations"] = "array<building_desc_x>(building_desc_x::building_type, way_types, good_desc_x)"
	...
	export_types["::get_available_ways"] = "array<way_desc_x>(way_types, way_system_types)"
	...
	export_types["::create"] = "string(coord, player_x, string)"
