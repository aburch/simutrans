...
BEGIN {
	...
	export_types["::forbid_way_tool_rect"] = "void(integer, integer, way_types, coord, coord)"
	export_types["::allow_way_tool_rect"] = "void(integer, integer, way_types, coord, coord)"
	export_types["::forbid_way_tool_cube"] = "void(integer, integer, way_types, coord3d, coord3d)"
