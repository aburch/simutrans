...
void export_map_objects(HSQUIRRELVM vm)
{
	 ...
	 */
	register_method(vm, &gebaeude_t::get_passagier_level, "get_passenger_level"); // TODO: Remove this deprecated code
	
	register_method(vm, &gebaeude_t::get_passagier_level, "get_adjusted_population");
	 ...
	 * @returns mail level
	 */
	register_method(vm, &gebaeude_t::get_post_level, "get_mail_level"); // TODO: Remove this deprecated code
