...
public:
    ...
    /**
     * Gibt die Farbe des Beschreibungstexthintergrundes zuÅck
    ...
    /**
     * Setze den Besitzer des Untergrundes. Gibt false zurÅck, wenn
    ...
    /**
     * LÑdt oder speichert die Daten des Untergrundes in eine Datei.
    ...
    /**
     * Manche Bˆden kˆnnen zu Haltestellen gehˆren.
    ...
    /**
     * Zeichnet Dinge des Grundes. Lˆscht das Dirty-Flag.
     * @author Hj. Malthaner
     */
    ...
    /**
     * Interface zur Bauen und abfragen von GebÑuden
     * =============================================
     */
    ...
    /**
     * Falls es hier ein Depot gibt, dieses zurÅckliefern
     * @author Volker Meyer
     */
     ...
     * ==============================
     * Jeder Boden hat bis zu 2. Special fÅr Wasser: ohne Weg-Objekt werden
     * alle ribis vom weg_t::wassert als gesetzt zurÅckgeliefert.
     */
     ...
     * Dies ist am Grund aufgehÑngt, da sich hier Wege kreuzen k˜nnen.
     *
	...
	*/
     ...
     * Wegs nicht hierÅber, sondern mit gib_weg(), ermittelt werden.
     * @author Hj. Malthaner
     */
    virtual ribi_t::ribi gib_weg_ribi(weg_t::typ typ) const;

     /**
     * Ermittelt die Richtungsbits fÅr den weg vom Typ 'typ' unmaskiert.
     * Dies wird beim Bauen ben˜tigt. FÅr die Routenfindung werden die
    ...
    /**
     * BrÅckenwege an den Auffahrten sind eine Ebene Åber der Planh˜he.
    ...
    /**
     * Hat der Boden mindestens ein weg_t-Objekt? Liefert false fÅr Wasser!
     * @author V. Meyer
     */
     ...
     * @param wegtyp	    um welchen wegtyp geht es
     * @param ribi_rem  sollen die ribis der nachbar zurÅckgesetzt werden?
     *
     * @author V. Meyer
     */
