...
static uint8 statistic_type[MAX_LINE_COST]={
	STANDARD, STANDARD, STANDARD, STANDARD, MONEY, MONEY, MONEY, STANDARD, STANDARD, STANDARD
};
	...
	scl(gui_scrolled_list_t::select)
{
	...
	vector_tpl<livery_scheme_t*>* schemes = sp->get_welt()->access_einstellungen()->get_livery_schemes();
