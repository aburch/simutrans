...
//	inp_filter.set_tooltip("Only show lines containing");
	...
	bt_withdraw_line.init(button_t::roundbox_state, "Withdraw All", koord(LINE_NAME_COLUMN_WIDTH, 14+SCL_HEIGHT+BUTTON_HEIGHT+2), koord(BUTTON_WIDTH,BUTTON_HEIGHT));
