	...
	gui_frame_t( translator::translate("Climate Control") )
{
	...
	// Winter snowline
	snowline_winter.init( sets->get_winter_snowline(), sets->get_groundwater(), sets->get_climate_borders()[arctic_climate]-sets->get_groundwater(), gui_numberinput_t::AUTOLINEAR, false );
