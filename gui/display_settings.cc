...
// y coordinates
#define GRID_MODE						(6)
#define UNDERGROUND						(GRID_MODE+LINESPACE)
#define SLICE							(UNDERGROUND+LINESPACE)
#define SLICE_LABEL						(SLICE+LINESPACE)
#define DAY_NIGHT						(SLICE_LABEL+LINESPACE)
#define BRIGHTNESS						(DAY_NIGHT+LINESPACE)
#define SCROLL_INVERS					(BRIGHTNESS+LINESPACE)
#define SCROLL_SPEED					(SCROLL_INVERS+LINESPACE)
#define LEFT_TO_RIGHT_GRAPHS			(SCROLL_SPEED+LINESPACE)

#define SEPERATE1						(LEFT_TO_RIGHT_GRAPHS+LINESPACE)

#define USE_TRANSPARENCY	(SEPERATE1+4)
#define HIDE_TREES			(USE_TRANSPARENCY+LINESPACE)
#define HIDE_CITY_HOUSES	(HIDE_TREES+LINESPACE)
#define HIDE_UNDER_CURSOR	(HIDE_CITY_HOUSES+LINESPACE)
...
#define SHOW_STATION_COVERAGE			(USE_TRANSPARENCY_STATIONS+LINESPACE)
#define SHOW_STATION_SIGNS				(SHOW_STATION_COVERAGE+LINESPACE)
#define SHOW_STATION_GOODS				(SHOW_STATION_SIGNS+LINESPACE)
#define SHOW_SIGNALBOX_COVERAGE				(SHOW_STATION_GOODS+LINESPACE)

#define SEPERATE3						(SHOW_SIGNALBOX_COVERAGE+LINESPACE)

#define CITY_WALKER								(SEPERATE3+4)
#define STOP_WALKER								(CITY_WALKER+LINESPACE)
#define DENS_TRAFFIC							(STOP_WALKER+LINESPACE)
#define CONVOI_TOOLTIPS							(DENS_TRAFFIC+LINESPACE)
#define CONVOI_NAMEPLATES						(CONVOI_TOOLTIPS+LINESPACE)
#define CONVOI_LOADINGBAR						(CONVOI_NAMEPLATES+LINESPACE)
#define HIGHLITE_SCHEDULE						(CONVOI_LOADINGBAR+LINESPACE)

#define SEPERATE4	(HIGHLITE_SCHEDULE+LINESPACE*3)
