...
/* stuff not set here ....
INIT_NUM( "intercity_road_length", environment_t::intercity_road_length);
...
void settings_general_stats_t::init(settings_t const* const sets)
{
	...
	for(  uint32 i=0;  i<lengthof(version);  i++  ) {
		...
		if(  strcmp(version[i],environment_t::savegame_version_str)==0  ) {
	...
	SEPERATOR
	INIT_NUM( "autosave", environment_t::autosave, 0, 12, gui_numberinput_t::AUTOLINEAR, false );
	INIT_NUM( "fast_forward", environment_t::max_acceleration, 1, 1000, gui_numberinput_t::AUTOLINEAR, false );
	SEPERATOR
	INIT_BOOL( "numbered_stations", sets->get_numbered_stations() );
	INIT_NUM( "show_names", environment_t::show_names, 0, 3, gui_numberinput_t::AUTOLINEAR, true );
	SEPERATOR
	...
	INIT_NUM( "show_month", environment_t::show_month, 0, 7, gui_numberinput_t::AUTOLINEAR, true );
	SEPERATOR
	INIT_NUM( "random_grounds_probability", environment_t::ground_object_probability, 0, 0x7FFFFFFFul, gui_numberinput_t::POWER2, false );
	INIT_NUM( "random_wildlife_probability", environment_t::moving_object_probability, 0, 0x7FFFFFFFul, gui_numberinput_t::POWER2, false );
	SEPERATOR
	INIT_BOOL( "pedes_and_car_info", environment_t::verkehrsteilnehmer_info );
	INIT_BOOL( "tree_info", environment_t::tree_info );
	INIT_BOOL( "ground_info", environment_t::ground_info );
	INIT_BOOL( "townhall_info", environment_t::townhall_info );
	INIT_BOOL( "only_single_info", environment_t::single_info );
...
void settings_general_stats_t::read(settings_t* const sets)
{
	...
	if(  0 <= selected  &&  (uint32)selected < lengthof(version)  ) {
		environment_t::savegame_version_str = version[ selected ];
	}
	...
	READ_NUM_VALUE( environment_t::autosave );
	READ_NUM_VALUE( environment_t::max_acceleration );

	READ_BOOL_VALUE( sets->numbered_stations );
	READ_NUM_VALUE( environment_t::show_names );
	...
	READ_NUM_VALUE( environment_t::show_month );

	READ_NUM_VALUE( environment_t::ground_object_probability );
	READ_NUM_VALUE( environment_t::moving_object_probability );

	READ_BOOL_VALUE( environment_t::verkehrsteilnehmer_info );
	READ_BOOL_VALUE( environment_t::tree_info );
	READ_BOOL_VALUE( environment_t::ground_info );
	READ_BOOL_VALUE( environment_t::townhall_info );
	READ_BOOL_VALUE( environment_t::single_info );
}

void settings_display_stats_t::init(settings_t const* const)
{
	INIT_INIT
	INIT_NUM( "frames_per_second",environment_t::fps, 10, 25, gui_numberinput_t::AUTOLINEAR, false );
	INIT_NUM( "simple_drawing_tile_size",environment_t::simple_drawing_default, 2, 256, gui_numberinput_t::POWER2, false );
	INIT_BOOL( "simple_drawing_fast_forward",environment_t::simple_drawing_fast_forward );
	INIT_NUM( "water_animation_ms", environment_t::water_animation, 0, 1000, 25, false );
	SEPERATOR
	INIT_BOOL( "window_buttons_right", environment_t::window_buttons_right );
	INIT_BOOL( "window_frame_active", environment_t::window_frame_active );
	INIT_NUM( "front_window_bar_color", environment_t::front_window_bar_color, 0, 6, gui_numberinput_t::AUTOLINEAR, 0 );
	INIT_NUM( "front_window_text_color", environment_t::front_window_text_color, 208, 240, gui_numberinput_t::AUTOLINEAR, 0 );
	INIT_NUM( "bottom_window_bar_color", environment_t::bottom_window_bar_color, 0, 6, gui_numberinput_t::AUTOLINEAR, 0 );
	INIT_NUM( "bottom_window_text_color", environment_t::bottom_window_text_color, 208, 240, gui_numberinput_t::AUTOLINEAR, 0 );
	SEPERATOR
	INIT_BOOL( "show_tooltips", environment_t::show_tooltips );
	INIT_NUM( "tooltip_background_color", environment_t::tooltip_color, 0, 255, 1, 0 );
	INIT_NUM( "tooltip_text_color", environment_t::tooltip_textcolor, 0, 255, 1, 0 );
	INIT_NUM( "tooltip_delay", environment_t::tooltip_delay, 0, 10000, gui_numberinput_t::AUTOLINEAR, 0 );
	INIT_NUM( "tooltip_duration", environment_t::tooltip_duration, 0, 30000, gui_numberinput_t::AUTOLINEAR, 0 );
	SEPERATOR
	INIT_NUM( "cursor_overlay_color", environment_t::cursor_overlay_color, 0, 255, gui_numberinput_t::AUTOLINEAR, 0 );
	INIT_BOOL( "left_to_right_graphs", environment_t::left_to_right_graphs );
...
void settings_display_stats_t::read(settings_t* const)
{
	READ_INIT
	// all visual stuff
	READ_NUM_VALUE( environment_t::fps );
	READ_NUM_VALUE( environment_t::simple_drawing_default );
	READ_BOOL_VALUE( environment_t::simple_drawing_fast_forward );
	READ_NUM_VALUE( environment_t::water_animation );

	READ_BOOL_VALUE( environment_t::window_buttons_right );
	READ_BOOL_VALUE( environment_t::window_frame_active );
	READ_NUM_VALUE( environment_t::front_window_bar_color );
	READ_NUM_VALUE( environment_t::front_window_text_color );
	READ_NUM_VALUE( environment_t::bottom_window_bar_color );
	READ_NUM_VALUE( environment_t::bottom_window_text_color );

	READ_BOOL_VALUE( environment_t::show_tooltips );
	READ_NUM_VALUE( environment_t::tooltip_color );
	READ_NUM_VALUE( environment_t::tooltip_textcolor );
	READ_NUM_VALUE( environment_t::tooltip_delay );
	READ_NUM_VALUE( environment_t::tooltip_duration );

	READ_NUM_VALUE( environment_t::cursor_overlay_color );
	READ_BOOL_VALUE( environment_t::left_to_right_graphs );
}
