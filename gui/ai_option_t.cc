	...
	label_cs( "construction speed" )
{
	...
	construction_speed.set_groesse( koord( 120, BUTTON_HEIGHT ) );
	...
	buttons[0].init( button_t::square_state, "road vehicle", koord(10,ypos), koord( 120, BUTTON_HEIGHT ) );
	...
	buttons[1].init( button_t::square_state, "rail car", koord(10,ypos), koord( 120, BUTTON_HEIGHT ) );
	...
	buttons[2].init( button_t::square_state, "water vehicle", koord(10,ypos), koord( 120, BUTTON_HEIGHT ) );
	...
	buttons[3].init( button_t::square_state, "airplane", koord(10,ypos), koord( 120, BUTTON_HEIGHT ) );
