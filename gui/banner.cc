...
void banner_t::zeichnen(koord pos, koord gr )
{
	...
	yp += LINESPACE+5;
#ifdef REVISION
	display_shadow_proportional( pos.x+4, yp, COL_WHITE, COL_BLACK, "Version " VERSION_NUMBER " " NARROW_EXPERIMENTAL_VERSION " " VERSION_DATE " r" QUOTEME(REVISION), true );
#else
	...
	display_shadow_proportional( pos.x+8, yp, 7, COL_BLACK,  "This version is modified by", true );
	yp += LINESPACE+5;
	...
	display_shadow_proportional( pos.x+8, yp, 7, COL_BLACK, "For more information, see the website and forum:", true );
	yp += LINESPACE+2;
