 ...
 */
class convoy_scrollitem_t : public gui_scrolled_list_t::scrollitem_t
{
private:
	convoihandle_t cnv;
public:
	convoy_scrollitem_t( convoihandle_t c ) : gui_scrolled_list_t::scrollitem_t( COL_ORANGE ) { cnv = c; }
