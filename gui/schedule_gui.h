...
class schedule_gui_t : public gui_frame_t, public action_listener_t
{
	...
	button_t bt_no_load, bt_no_unload, bt_tmp_schedule, bt_wait_for_time, 
		...
		bt_load_before_departure, bt_reverse_convoy, bt_reverse_coupling, bt_wait_coupling_done, bt_uncouple_child, bt_max_speed_kmh_of_convoi, bt_no_overtake, bt_pass_stop;
