...
*/
						...
						buf.clear();
						char capacity[32];
						sprintf(capacity, v->get_overcrowding(v->get_reassigned_class(i)) > 0 ? "%i (%i)" : "%i", v->get_capacity(v->get_reassigned_class(i)), v->get_overcrowding(v->get_reassigned_class(i)));
