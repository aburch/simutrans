...

{
	...
	*/
	...
	vector_tpl<livery_scheme_t*>* schemes = welt->access_einstellungen()->get_livery_schemes();
...
void gui_convoy_assembler_t::layout()
{
	...
	*/
	...
	if(welt->access_einstellungen()->get_livery_scheme(livery_scheme_index)->is_available((welt->get_timeline_year_month())))
	{
