		...
		if (skinverwaltung_t::alerts) {
			switch (cnv->get_state()) {
				case convoi_t::EMERGENCY_STOP:
					display_color_img(skinverwaltung_t::alerts->get_image_id(2), pos.x + offset.x + 2 + w, pos.y + offset.y + 6, 0, false, false);
				...
				case convoi_t::CAN_START_ONE_MONTH:
					display_color_img(skinverwaltung_t::alerts->get_image_id(3), pos.x + offset.x + 2 + w, pos.y + offset.y + 6, 0, false, false);
				...
				case convoi_t::CAN_START_TWO_MONTHS:
					display_color_img(skinverwaltung_t::alerts->get_image_id(4), pos.x + offset.x + 2 + w, pos.y + offset.y + 6, 0, false, false);
			...
			if (cnv->get_replace()) {
				display_color_img(skinverwaltung_t::alerts->get_image_id(1), pos.x + offset.x + 2 + w, pos.y + offset.y + 6, 0, false, false);
