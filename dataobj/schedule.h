...
public:
	 ...
	 */
	bool insert(const grund_t* gr, uint8 minimum_loading = 0, uint16 waiting_time_shift = 0, uint16 stop_flags = 0, uint16 max_speed_kmh_of_convoi = 0);

	/**
	 * Appends a coordinate to the schedule.
	 */
	bool append(const grund_t* gr, uint8 minimum_loading = 0, uint16 waiting_time_shift = 0, uint16 stop_flags = 0, uint16 max_speed_kmh_of_convoi = 0);
