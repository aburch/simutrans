...
public:
	...
	enum {
		...
		TEMP_LOAD         = 1U << 14,// load temporary(not use for goods routing)
		TEMP_UNLOAD       = 1U << 15,// unload temporary(not use for goods routing)
		TEMP_UNLOAD_ALL   = 1U << 16 // unload all only for goods routing
	};
