...
public:
	// do not call th
	crossing_logic_t( const kreuzung_desc_t *desc );
...
private:
	static slist_tpl<const kreuzung_desc_t *> liste;
	// save all desc' only for waytype0 < waytype1
	static minivec_tpl<const kreuzung_desc_t *> can_cross_array[36];

public:
	static void register_desc(kreuzung_desc_t *desc);
	 ...
	 */
	static const kreuzung_desc_t *get_crossing(const waytype_t ns, const waytype_t ow, sint32 way_0_speed, sint32 way_1_speed, uint16 timeline_year_month);
