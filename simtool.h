...
private:
	bool tool_remover_intern(spieler_t *sp, koord3d pos, sint8 type, const char *&msg);
public:
...
private:
	...
	const char *tool_station_aux(spieler_t *, koord3d, const haus_besch_t *, waytype_t, const char *halt_suffix );
